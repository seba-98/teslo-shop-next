...
type ValidSizes ={ value:validSizes, inStock:number, price:number }
...
export const initialData: SeedData = {
    ...
    users:[
        ...
        },
        {
            ...
            phoneNumber:'+2255474811',
            password   :bcrypt.hashSync('juan1235', 10),
            role       :'admin',
        },
        {
            name       :'jose',
            email      :'jose1@gmail.com',
            phoneNumber:'+2225472711',
            password   :bcrypt.hashSync('jose1235', 10),
            role       :'admin',
        },
        {
            name       :'hernando',
            email      :'hernando1@gmail.com',
            phoneNumber:'+2244472861',
            password   :bcrypt.hashSync('hernando1235', 10),
            role       :'client',
        },
        {
            name       :'roberto',
            email      :'roberto1@gmail.com',
            phoneNumber:'+2258872811',
            password   :bcrypt.hashSync('roberto1235', 10),
            role       :'client',
        },
    ],
    products: [
        {
            ...
            sizes:[ 
                { value:'XS', inStock:45, price:70},
                { value:'S', inStock:20, price:100},
                { value:'M', inStock:15, price:100},
                { value:'L', inStock:10, price:110},
                { value:'XL', inStock:12, price:110},
                { value:'XXL', inStock:22, price:130},
                { value:'XXXL', inStock:20, price:130},
            ],
        ...
        
        {
            ...
            sizes:[ 
                { value:'XS', inStock:0, price:70},
                { value:'S', inStock:0, price:100},
                { value:'M', inStock:15, price:100},
                { value:'L', inStock:10, price:110},
                { value:'XL', inStock:12, price:110},
                { value:'XXL', inStock:22, price:130},
                { value:'XXXL', inStock:0, price:130},
            ],
        ...
        },
        {
            ...
            sizes:[ 
                { value:'XS', inStock:0, price:70},
                { value:'S', inStock:0, price:100},
                { value:'M', inStock:0, price:100},
                { value:'L', inStock:0, price:110},
                { value:'XL', inStock:0, price:110},
                { value:'XXL', inStock:0, price:130},
                { value:'XXXL', inStock:0, price:130},
            ],
